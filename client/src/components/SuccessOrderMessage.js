...
export const SuccessOrderMessage = ({ handleCloseSuccessModal }) => {
    return (
        <Container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }} >
            ...
            <Typography variant="body1" gutterBottom mt="15px" textAlign="justify">
                Мы приняли ваш заказ и свяжемся с Вами в течение 24 часов по указанному номеру телефона.
                Конечную стоимость, наличие товара и способы доставки продукции уточняйте у консультанта.
            </Typography>
        </Container>
    )
}